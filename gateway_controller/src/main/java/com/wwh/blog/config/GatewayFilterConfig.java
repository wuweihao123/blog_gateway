...
import com.wwh.blog.constant.RSAConstant;
import com.wwh.blog.pojo.MyCachedBodyOutputMessage;
import com.wwh.blog.util.Constant;
import com.wwh.blog.util.FilterUtils;
import com.wwh.springcloud.uitl.RSAUtils;
...
public class GatewayFilterConfig implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (!pathMatcher.match("/user/login", requestUrl)) {
            ...
            if(StringUtils.isBlank(token) || null == claim) {
    ...
    public void checkSign(String sign, Long dateTimestamp, String requestId, Map<String, Object> paramMap) {
        ...
        try {
            String tempSign = MD5Utils.md5Hex(str.getBytes());
